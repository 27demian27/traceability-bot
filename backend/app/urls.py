...
from .chat.views import ChatBotView, DocumentUploadView, CodeUploadView, EmbeddingView, ClearSessionView, GraphView
...
urlpatterns = [
    ...
    path('chat/graph/', GraphView.as_view(), name='chat-graph')
]
